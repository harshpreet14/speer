...
const Header = () =>{
    ...
    return(
      ...
      <svg className="h-[75px] w-[90px]" viewBox='0 0 486 168' version='1.1' xmlns='http://www.w3.org/2000/svg'>
      ...
      >
        <ul>
          ...
          <Link to="/inbox" className="hover:text-black hover:font-semibold flex justify-center items-center bg-transparent px-6 gap-2">
          <img className="w-5" src={incoming} alt="Inbox" />
          Inbox
          </Link>
          <Link to="/" className="hover:text-black hover:font-semibold  text-center justify-center">
          All Calls
          </Link>
          <Link to="/archived" className="hover:text-black hover:font-semibold flex justify-center items-center bg-transparent px-6 gap-2">
          <img className="w-5" src={archive} alt="Archived" />
          Archived
          </Link>
          </div>
